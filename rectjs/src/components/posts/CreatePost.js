	                ...
	                <div className="panel-body">
	                    <form method="POST" action="#" encType="multipart/form-data">
	                        ...
	                        <div className="form-group">
	                            ...
	                            <textarea id="body" value={this.state.body} name="body" className="form-control" onChange={this.onHandleChangeBody}></textarea>
	                            <span className="help-block">
	                        ...
	                        <div className="form-group">
	                            ...
	                            <select name="category_id" value={this.state.value} onChange={this.onHandleChangeCategory}>
	                                {option}
	                            </select>
	                        </div>
