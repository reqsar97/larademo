...
export default class UpdatePost extends Component {
	...
	render(){
		...
		let redirect = this.state.createPostSuccess && <Redirect push to={`/posts/userPosts/post/${this.state.id}`} />
		                                ...
		                                <td>
		                                    <form method="POST" action="#" className="form-group">
		                                        <div className="form-group">
		                                            ...
		                                            <input type="text" className="form-control" id="title" name="title" required onChange={this.onHandleChangeTitle}/>
		                                        </div>

		                                        <div className="form-group">
		                                            <label htmlFor="name">Text:</label>
		                                            <textarea id="body" name="body" className="form-control" onChange={this.onHandleChangeBody}></textarea>
		                                        </div>

		                                        <button type="submit" className="btn btn-primary" onClick={this.onHandleClickSubmit}>Update</button>
		                                    </form>
